...
class WxPayConfig extends WxPayConfigInterface {
    ...
    public function GetAppId() {
         return $this->config['appId'];//   'wx5e042b6fd81a5530';
    }

    public function GetMerchantId() {
        return $this->config['MerchantId'];//  '1500180242';
    }
    ...
    public function GetKey() {
        return $this->config['Key'];//'qwerfdsa10287593tyghbnrf08548392';
    }

    public function GetAppSecret() {
        return $this->config['AppSecret'];// '2c3ebbd35d1a6b94e3ccca8118acd351';
    }
